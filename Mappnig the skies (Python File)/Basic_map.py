...
m = Basemap(projection='merc', resolution='h', llcrnrlon=68,
            llcrnrlat=7, urcrnrlon=97, urcrnrlat=37)

# Draw the coastlines and country borders
m.drawcoastlines(linewidth=0.5)
m.drawcountries(linewidth=1)

# Fill the land area with light green color and draw the Indian states boundaries
m.fillcontinents(color='#33ccff', lake_color='#00394d')
